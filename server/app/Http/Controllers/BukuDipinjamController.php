...
class BukuDipinjamController extends Controller
{
    ...
    {
        $bukuDipinjam['bukuDipinjam'] = BukuDipinjam::orderBy('status', 'ASC')->get();
    ...
    public function store(Request $request)
    {
        ...
        if ($databuku->stok>0){
            ...
            return redirect()->back()->with("ERR", "Maaf, Jumlah peminjaman terbatas 3 !");
            }
        }else{
