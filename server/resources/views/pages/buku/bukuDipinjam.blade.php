                    ...
                    <table class="table table-striped table-bordered table-responsive zero-configuration datatable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                @if($item->status == 1)
                                <td class="text-capitalize"><span class="badge badge-success">Kembali</span></td>
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" style="min-width: 9rem !important">
                                            <button id="Perpanjang" class="dropdown-item editBukuButton" value="{{ $item->id }}" disabled>
                                                <i class="la la-edit"></i> Perpanjang
                                            </button>
                                            <button id="kembalikan" class="dropdown-item deleteBukuButton" value="{{ $item->id }} " disabled>
                                ...
                                @else
                                <td class="text-capitalize"><span class="badge badge-danger">Belum Kembali</span></td>
                                <td>
                                    <div class="dropdown">
                                        <button class="btn btn-info dropdown" type="button" data-toggle="dropdown">
                                            <i class="la la-cog"></i>
            ...
            <form action="{{ route('bukuDipinjam.store') }}" method="post">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="judulbuku" id="judulbuku" placeholder="Judul Buku" class="form-control" disabled>
                    </div>
                    <div class="form-group">
                        <label for="">Penerbit</label>
                        <input type="text" name="penerbit" id="penerbit" placeholder="Penerbit" class="form-control" disabled>
                    </div>
                    <div class="form-group">
                        <label for="">Tahun Terbit</label>
                        <input type="text" name="tahunterbit" id="tahunterbit"  placeholder="Tahun terbit" class="form-control" disabled>
                    </div>
                    <div class="form-group">
                        <label for="">Penulis</label>
                        <input type="text" name="penulis" id="penulis" placeholder="Penulis" class="form-control" disabled>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="namapeminjam" id="namaanggota" placeholder="Nama Peminjam" class="form-control" disabled>
                    </div>
